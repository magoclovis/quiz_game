...
// Chamando a função para exibir a primeira pergunta
showQuestion(currentQuestionIndex);
...
// Atualize o elemento de pergunta no HTML com a pergunta correta
...
const questions = [
    ...
    {
        question: 'Qual é o Yordle mais velho?',
        answers: ['Heimerdinger', 'Gnar', 'Kled', 'Vex'],
